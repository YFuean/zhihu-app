<template>
	<div>
		<div class="nav-bar shadow mb-2 fill-white">
			<div class="container row">
				...
				<div class="fruid-col-5 d-flex align-items-center pl-4">
					<input type="text" placeholder="请输入关键字" class="input-box mr-2" maxlength="100" />
					<button class="blue-fill-btn">提问</button>
				</div>

				<div class="fruid-col-3 d-flex justify-content-end align-items-center">
					<svg class="grey-icon" viewBox="0 0 24 24" width="22" height="22">
					...
					<svg class="grey-icon ml-5" viewBox="0 0 24 24" width="22" height="22">
					...
					<img :src="user.avatar" v-if="token" width="30" height="30" class="tiny-round link ml-5" @click="$router.push('/people/' + user.url)" />
					<span v-else class="link ml-5">
						<router-link to="/login">登录</router-link>
						<!-- <router-link to="/people">测试</router-link> -->
					</span>
				</div>
			</div>
		</div>
